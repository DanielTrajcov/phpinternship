...
<nav class="text-2xl">
  <div class="max-w-7xl mx-auto px-2 sm:px-8 lg:px-6">
    <div class="relative flex items-center justify-between h-16 ">
        <a href="index.php" class="text-white  text-3xl font-bold">
...
<div class="flex flex-col items-center justify-center space-y-8 py-10">
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        <h1 class="mb-4 text-4xl font-extrabold md:text-5xl lg:text-6xl accent">Who doesn't love a little friendly competition?</h1>
        <p class="mb-8 text-lg font-normal text-gray-400 lg:text-xl sm:px-16 xl:px-48 ">Vote for your colleagues, leave a comment, and let the best shine!</p>
        <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a href="?vote" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg border border-gray-700">
